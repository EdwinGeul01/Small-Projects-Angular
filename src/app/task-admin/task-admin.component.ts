  ...
  Create_task()
    {
      ...
      if(tasks != null && title != null && body != null)
      {
        ...
        temp += " <div class=\"task w-[40%]  min-h-[50%] max-h-[80%] bg-slate-300 mt-10 mb-20 ml-10 shadow-md shadow-slate-400 tareas \"  id=task"+this.number_task+">\
        <div class=\"px-4 py-4\">\
            ...
            <div class=\"w-full flex justify-center mt-4\">\
                <button class=\"border px-6 py-2 bg-red-300 hover:bg-red-500 duration-200 text-white \" onclick=\"delete_task(\'task" + this.number_task + "\')\">Eliminar</button>\
                </div>\
            </div>\
        </div>";
